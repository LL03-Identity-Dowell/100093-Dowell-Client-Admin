...
const Settingform11 = () => {
  ...
  const [selectedcolor_scheme, setSelectedcolor_scheme] =
    useState(color_scheme);
      ...
      >
        <div className="w-full mb-3">
          ...
          <select
            ...
            value={selectedcolor_scheme}
          >
            <option value={selectedcolor_scheme}>{selectedcolor_scheme}</option>
