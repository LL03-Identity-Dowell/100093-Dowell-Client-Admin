  ...
  return (
    <>
      <div className="border border-black card-shadow lg:w-1/4 px-2 py-2">
        ...
        <section className="card-shadow border-black border mt-8 bg-[#cef9d2]">
          <div className="border-b border-black p-1">
            <button
              className="border border-[#ff0036] text-[#ff0036] text-[13px] font-roboto rounded-[5px] px-5 py-[10px] hover:bg-[#61ce70] hover:text-white hover:border-white"
              onClick={() =>
                (window.location.href =
                  "https://100093.pythonanywhere.com/upload")
              }
            >
              Upload
            </button>
          </div>
          <div className="flex justify-between items-center border-t border-black p-1">
            <button
              className="border border-[#ff0036] text-[#ff0036] text-[13px] font-roboto rounded-[5px] px-5 py-[10px] hover:bg-[#61ce70] hover:text-white hover:border-white"
              onClick={() =>
                (window.location.href = `https://ll03-identity-dowell.github.io/100096-DowellChat/#/living-lab-chat/?session_id=${sessionId}`)
              }
            >
              Customer Support
            </button>
