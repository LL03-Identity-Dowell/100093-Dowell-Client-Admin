...
const WorkspaceHeader = () => {
  ...
  const otherOrganisations = useSelector((state: RootState) => state.adminData.data[0].other_organisation);
  console.log(otherOrganisations)
              ...
              {currentPath == "/setting" ? (
                ...
                >
                  ...
                  >
                    ...
                    {otherOrganisations.map((org, index) => (
