...
import EditForm from "../components/editPortfolio/EditPortfolioForm";
import PortfolioList from "../components/editPortfolio/EditPortfolioList";
import EditHeader from "../components/editPortfolio/editHeader";
        ...
        <Layout>
          <main>
            <div className="container mx-auto mb-20 lg:px-0 px-4">
              <EditHeader />
              <section className="mt-4 flex flex-col gap-8 justify-end">
