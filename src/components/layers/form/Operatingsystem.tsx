    ...
    <>
      ...
      <form className="px-[30px] mb-8">
        <div className="mb-4">
          ...
          >
            <option disabled={Boolean(Windows)} selected>
        ...
        <div className="mb-4">
          ...
          >
            <option disabled={Boolean(macos)} selected>
              …select security layer…
            </option>
            {macos && (
        ...
        <div className="mb-4">
          ...
          >
            <option disabled={Boolean(linux)} selected>
              …select security layer…
            </option>
            {linux && (
        ...
        <div className="mb-4">
          ...
          >
            <option disabled={Boolean(Android)} selected>
              …select security layer…
            </option>
            {Android && (
        ...
        <div className="mb-4">
          ...
          >
            <option disabled={Boolean(ios)} selected>
              …select security layer…
            </option>
            {ios && (
        ...
        <div className="mb-4">
          ...
          >
            <option disabled={Boolean(Other)} selected>
              …select security layer…
            </option>
            {Other && (
