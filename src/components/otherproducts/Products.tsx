...
const Products = () => {
	...
	const selectedorg = useSelector((state: RootState) => state.selectedorg.orgname);
				...
				<div className="mt-8">
					<div className="pl-8">
						<p className="font-roboto text-lg text-[#7a7a7a] font-semibold my-8">
							Products of <span className="text-[#FF0000]">{selectedorg}</span>,
							Owner <span className="text-[#FF0000]">{selectedorg}</span>
						</p>
