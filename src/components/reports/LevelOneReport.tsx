...
const LevelOneReport: React.FC<LevelOneReportProps> = ({ data }) => {
      ...
      <table className="w-full border-collapse border border-gray-400">
        <thead className="bg-gray-200">
          <tr>
            ...
            <th className="border border-gray-400 px-2">Item Universal Code</th>
            <th className="border border-gray-400 px-2">Item Details</th>
            <th className="border border-gray-400 px-2">Item Specification</th>
