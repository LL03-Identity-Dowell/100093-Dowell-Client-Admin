...
import Department from "./SchoolManagement/Department";
import Bus from "./SchoolManagement/Bus";
import Class from "./SchoolManagement/Class";
import Teacher from "./SchoolManagement/Teacher";
import Students from "./SchoolManagement/Students";
import { Axios93Base } from "../api/axios";

const SchoolManagementTabs = () => {
...
export default SchoolManagementTabs;
