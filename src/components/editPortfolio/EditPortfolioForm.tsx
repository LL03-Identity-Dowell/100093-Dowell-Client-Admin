        ...
        <form className="" onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold flex items-end gap-1">
              <span id="portfolioEditFormText3">Select Member Type </span>
          ...
          <div className="mb-4">
            <div className="flex items-center gap-3">
              <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
                <span id="portfolioEditFormText4">Select Member </span>
                <span className="text-[#ff0000] text-base">*</span>
              </label>
              <label className="text-[#7A7A7A] text-lg font-roboto font-bold flex items-center gap-2">
                <span id="portfolioEditFormText5"> Select All</span>
                <input
                  type="checkbox"
            ...
            <select
              required
              multiple
              name="portfolioEditFormSelect2"
              id="portfolioEditFormSelect2"
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold">
              <span id="portfolioEditFormText7">Select Product </span>
              <span className="text-[#ff0000] text-base">*</span>
            </label>
            <select
              required
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
              <span id="portfolioEditFormText8">Select Data Type </span>
              <span className="text-[#ff0000] text-base">*</span>
            </label>
            <select
              onChange={handleSelectStatus}
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
              <span id="portfolioEditFormText10"> Select Roles</span>{" "}
              <span className="text-[#ff0000] text-base">*</span>
            </label>
            <select
              required
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
              <span id="portfolioEditFormText11">Portfolio Name </span>
              <span className="text-xs text-[#FF0000]">
                {" "}
                <span id="portfolioEditFormText12">
                  {" "}
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
              <span id="portfolioEditFormText13">Portfolio Code (Unique) </span>
              <span className="text-[#ff0000] text-base">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
              <span id="portfolioEditFormText14">Portfolio Specification </span>
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="text-[#7A7A7A] text-lg font-roboto font-bold ">
              <span id="portfolioEditFormText16"> Portfolio Details </span>
            </label>
            <textarea
              rows={4}
