    ...
    if (status == "") {
      ...
      try {
        await Axios93Base.post("/update_item_status/", data).then((res) => {
          ...
          const updateditems = level1Items.map((role) => {
