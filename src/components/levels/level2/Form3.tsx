...
const Form3 = () => {
  ...
  if (isnewOwner) {
    level2Items = useSelector(
      (state: RootState) =>
        state.adminData.data[0]?.organisations[1]?.level2?.items
    );
  }
