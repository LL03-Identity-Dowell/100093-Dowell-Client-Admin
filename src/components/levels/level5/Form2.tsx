        ...
        if (res.status === 201) {
          ...
          if (isnewOwner) {
            dispatch(
              setItemData({
                data: [
                  ...currentadmindata.data[0].organisations[1].level5.items,
                  newdata,
                ],
                type: "level5",
              })
