...
const Form3 = () => {
  ...
  if (isnewOwner) {
    level3Items = useSelector(
      (state: RootState) =>
        state.adminData.data[0]?.organisations[1]?.level3?.items
    );
  ...
  const selectedItemData = level3Items.find(
    ...
    if (status == "") {
      ...
      try {
        await Axios93Base.post("/update_item_status/", data).then((res) => {
          ...
          const updateditems = level3Items.map((role) => {
                    ...
                    organisations: [
                      {
                        ...
                        level3: {
                          ...currentadmindata.data[0].organisations[1].level3,
                          items: updateditems,
                        },
                      },
                    ],
