...
const Form3 = () => {
  ...
  if (isnewOwner) {
    level4Items = useSelector(
      (state: RootState) =>
        state.adminData.data[0]?.organisations[1]?.level4?.items
    );
  }
					  ...
					  organisations: [
						{
						  ...
						  level4: {
							...currentadmindata.data[0].organisations[1].level4,
							items: updateditems,
						  },
						},
					  ],
