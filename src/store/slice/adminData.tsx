...
const adminDataSlice = createSlice({
  ...
  reducers: {
    ...
    setAdminData: (state, action) => {
      ...
      state.data[0].roles = action.payload.roles;
    ...
    setItemData: (state, action) => {
      if (action.payload.type === "level1") {
        state.data[0].organisations[1].level1.items = action.payload.data;
      } else if (action.payload.type === "level2") {
        state.data[0].organisations[1].level2.items = action.payload.data;
      } else if (action.payload.type === "level3") {
        state.data[0].organisations[1].level3.items = action.payload.data;
      } else if (action.payload.type === "level4") {
        state.data[0].organisations[1].level4.items = action.payload.data;
